...
class HeroRoutes extends BaseRoutes{
    ...
    list(){
        return {
            ...
            config: {//validações via joi
                tags:['api'],//tag aponta o Endponint para visualizar no SWAGGER
                description: 'Recupera a lista de Personagens', //isso é repassado para o swagger também,
                notes: 'Pode-se paginar os resultados e fitrar por nome.',//notes também é repassado para o swagger
                validate:{  
    ...
    create(){
        return {
            ...
            config: {//validações via joi
                tags:['api'],//tag aponta o Endponint para visualizar no SWAGGER
                description: 'Criação de Personagens no Banco', //isso é repassado para o swagger também,
                notes: 'Persiste um novo personagem no banco',//notes também é repassado para o swagger
                validate:{  
                    //validaçõesem payload -> body
                    // validações headers -> header
                    // validações em params -> na urls 
    ...
    update(){
        return {
            ...
            config: {//validações via joi
                tags:['api'],//tag aponta o Endponint para visualizar no SWAGGER
                description: 'Atualiza todo ou parcialmente o Personagem', //isso é repassado para o swagger também,
                notes: 'Há a necessidade de se passar um id valido tipo String',//notes também é repassado para o swagger
                validate:{  
                    //validaçõesem payload -> body
                    // validações headers -> header
                    // validações em params -> na urls 
    ...
    delete(){
        return {
            ...
            config: {//validações via joi - biblioteca de validação
                tags:['api'],//tag aponta o Endponint para visualizar no SWAGGER
                description: 'Deleta de Personagens no Banco', //isso é repassado para o swagger também,
                notes: 'Há a necessidade de se passar um id valido tipo String do item que quer deletar',//notes também é repassado para o swagger
                validate:{  
                    //validaçõesem payload -> body
                    // validações headers -> header
                    // validações em params -> na urls 
