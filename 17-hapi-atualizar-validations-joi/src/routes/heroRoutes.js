        ...
        return {
            ...
            handler: async (request, headers) => {
                try {
                    ...
                    return 'HeroRoutes - create() -> Internal Error!'
                }
            }
        }
    }
        ...
        return {
            ...
            handler: async (request, headers) => {
                try {
                    ...
                    if(result.nModified !== 1 )return { message: 'Não foi possivel realizar a alteração do personagem!'}
                    
                    return { message: 'Heroi alterado com sucesso!'}

                } catch (error) {
                    console.log('HeroRoutes - update() -> Problemas aa alterar dado no banco.\n ERRO: ', error)
                    return 'HeroRoutes - update() -> Internal Error!'
                }
            }
        }
    }
